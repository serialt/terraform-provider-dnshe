...
func TestAccDataSourceSubdomain(t *testing.T) {
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckResourceAttrWith("data.dnshe_subdomain.test_domain", "id", func(value string) error {
						t.Log("\n======================= 🔍 DNSHE 数据打样 🔍 =======================")
...
const testAccDataSourceSubdomainConfig = `
data "dnshe_subdomain" "test_domain" {
  subdomain_id  = "xxxxx"
}
`
